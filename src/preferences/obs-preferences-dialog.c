...
G_DEFINE_FINAL_TYPE(ObsPreferencesDialog, obs_preferences_dialog,
		    ADW_TYPE_WINDOW)

static void obs_preferences_dialog_finalize(GObject *object)
{
...
static void obs_preferences_dialog_class_init(ObsPreferencesDialogClass *klass)
{
	...
	gtk_widget_class_set_template_from_resource(
		widget_class,
		"/com/obsproject/Studio/GTK4/ui/preferences/obs-preferences-dialog.ui");
}

static void obs_preferences_dialog_init(ObsPreferencesDialog *self)
{
